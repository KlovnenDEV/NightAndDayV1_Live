...
Config.ClothingShops = {
	...
	[22] = {
		blip = false,
		coords = vector3(1772.64, -2586.43, 45.8),
		MarkerSize   = {x = 2.0, y = 2.0, z = 0.0}
	},
	[23] = {
		blip = false,
		coords = vector3(-341.49, -162.17, 44.59),
		MarkerSize   = {x = 2.0, y = 2.0, z = 0.0}
	},
	[24] = {
		blip = false,
		coords = vector3(300.96, -596.54, 43.28),
		MarkerSize   = {x = 2.0, y = 2.0, z = 0.0}
	},	
	[25] = {
		blip = false,
		coords = vector3(462.72, -998.11, 31.13),
		MarkerSize   = {x = 2.0, y = 2.0, z = 0.0}
	},
	[26] = {
		blip = false,
...
Config.PDPresets = {
	[1] = {
		blip = false,
		coordss = vector3(107.64, -1304.9, 28.79),
