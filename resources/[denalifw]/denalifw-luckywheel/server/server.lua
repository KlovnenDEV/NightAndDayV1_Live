            ...
            if PlayerData.money['bank'] >= amount then
                ...
                SetTimeout(6000, function()
                    ...
                    if _priceIndex == 1 or _priceIndex == 9 or _priceIndex == 13 or _priceIndex == 17 then
                        TriggerClientEvent('denalifw-vehicleshop:client:winCar', _source, carname)
                        TriggerClientEvent('DenaliFW:Notify', _source, 'Lucky Wheel: You won a car!', 'success')
                    ...
                    elseif _priceIndex == 3 or _priceIndex == 7 or _priceIndex == 15 or _priceIndex == 20 then
                        ...
                        TriggerClientEvent('DenaliFW:Notify', _source, 'Lucky Wheel: You won a total of $' .. _money .. '!', 'success')
