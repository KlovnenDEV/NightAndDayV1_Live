...
AddEventHandler("safecracking:loop", function()
	...
	local pinfall = false
	while cracking do
		SetInstructionalButton("Left", 38, true)
		SetInstructionalButton("Right", 75, true)
		SetInstructionalButton("Confirm", 74, true)
		--ShowHelpText("Press E left | F right | H to crack")
	...
	resetAnim()
	SetInstructionalButton("Left", 38, false)
	SetInstructionalButton("Right", 75, false)
	SetInstructionalButton("Confirm", 74, false)
end)
