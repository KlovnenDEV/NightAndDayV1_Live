...
function loadBoostData() {
  fetch("https://nv-carboost/setupboostapp", {
    method: "POST",
    headers: {
...
function buyContract(event) {
  Confirm.open({
    ...
    cancelText: "No",
    onOk: () => {
      fetch("https://nv-carboost/buycontract", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function transferContract(event) {
  ...
  Confirm.Input({
    ...
    onOk: function (value) {
      ...
      fetch("https://nv-carboost/transfercontract", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function sellContract(event) {
  ...
  Confirm.Input({
    ...
    onOk: (value) => {
      if (value) {
        fetch(`https://nv-carboost/sellcontract`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
function toggleBoosting(event) {
  ...
  if (isStart) {
    ...
    function checkCanStart(type) {
      fetch("https://nv-carboost/canStartContract", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function startContract(data) {
  $.post("https://nv-carboost/startcontract", JSON.stringify({ data: data }));
}

function stopContract(data) {
  $.post("https://nv-carboost/stopcontract", JSON.stringify({ id: data }));
}
