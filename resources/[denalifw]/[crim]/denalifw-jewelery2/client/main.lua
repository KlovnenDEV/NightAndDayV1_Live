...
local function smashVitrine(k)
    ...
    DenaliFW.Functions.Progressbar("smash_vitrine", "Stocking a display", Config.WhitelistedWeapons[pedWeapon]["timeOut"], false, true, {
        ...
        TriggerServerEvent('denalifw-jewellery2:server:setVitrineState', "isOpened", true, k)
        TriggerServerEvent('denalifw-jewellery2:server:setVitrineState', "isBusy", false, k)
        TriggerServerEvent('denalifw-jewellery2:server:vitrineReward')
        TriggerServerEvent('denalifw-jewellery2:server:setTimeout')
    ...
    TriggerServerEvent('denalifw-jewellery2:server:setVitrineState', "isBusy", true, k)
...
RegisterNetEvent('denalifw-jewellery2:client:setVitrineState', function(stateType, state, k)
                    ...
                    if dist < 0.6 then
                        if not Config.Locations[case]["isBusy"] and not Config.Locations[case]["isOpened"] then
                            ...
                            if IsControlJustPressed(0, 38) then
                                DenaliFW.Functions.TriggerCallback('denalifw-jewellery2:server:getCops', function(cops)
