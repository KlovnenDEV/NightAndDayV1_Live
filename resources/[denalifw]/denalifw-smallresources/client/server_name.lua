function SetData()
	...
	Citizen.InvokeNative(GetHashKey("ADD_TEXT_ENTRY"), 'FE_THDR_GTAO', "~q~Night And Day ROLEPLAY~s~  | ID: "..id.." | ~r~".. #players .." connected")
end
...
Citizen.CreateThread(function()
    AddTextEntry("PM_PANE_LEAVE", "~r~Sign out ~p~Night and Day ROLEPLAY")
end)
