...
RegisterNetEvent('qb-smallresources:client:get:tackeled')
AddEventHandler('qb-smallresources:client:get:tackeled', function()
    SetPedToRagdoll(GetPlayerPed(-1), math.random(4000, 5000), math.random(4000, 5000), 0, 0, 0, 0) 
end)

RegisterNetEvent('qb-smallresources:client:lockpick:animation')
AddEventHandler('qb-smallresources:client:lockpick:animation', function(Bool)
    Lockpicking = Bool
...
RegisterNetEvent('qb-smallresources:client:thermite:anim')
AddEventHandler('qb-smallresources:client:thermite:anim', function(Coords)
    exports['qb-smallresources']:RequestModelHash("hei_p_m_bag_var22_arm_s")
    exports['qb-smallresources']:RequestAnimationDict("anim@heists@ornate_bank@thermal_charge")
...
RegisterNetEvent('qb-smallresources:client:reset:thermite:anim')
AddEventHandler('qb-smallresources:client:reset:thermite:anim', function()
...
RegisterNetEvent('qb-smallresources:client:explosion:anim')
AddEventHandler('qb-smallresources:client:explosion:anim', function(Coords, Rotation)
    exports['qb-smallresources']:RequestModelHash("ch_prop_ch_explosive_01a")
    exports['qb-smallresources']:RequestAnimationDict("anim_heist@hs3f@ig8_vault_explosives@right@male@")
...
RegisterNetEvent('qb-smallresources:client:reset:expolsion:anim')
AddEventHandler('qb-smallresources:client:reset:expolsion:anim', function()
    ClearPedTasks(PlayerPedId())
    for k, v in pairs(HeistProps) do
        if DoesEntityExist(v) then
            NetworkRequestControlOfEntity(v)
