...
QBShared.Items = {
	...
	['weapon_snspistol_mk2'] 	     = {['name'] = 'weapon_snspistol_mk2', 		 	['label'] = 'Paintball Gun', 		['weight'] = 1000, 		['type'] = 'weapon', 	['ammotype'] = 'AMMO_PAINTBALL',			['image'] = 'weapon_snspistol_mk2.png', ['unique'] = true, 		['useable'] = true, 	['description'] = 'SNS Pistol MK2'},
