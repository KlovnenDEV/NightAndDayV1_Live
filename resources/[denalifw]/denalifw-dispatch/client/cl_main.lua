...
RegisterNetEvent('dispatch:manageNotifs', function(sentSetting)
    ...
    if wantedSetting == "on" then
        ...
        DenaliFW.Functions.Notify("Dispatch enabled", "success")
    elseif wantedSetting == "off" then
        disableNotis = true
        disableNotifSounds = true
        DenaliFW.Functions.Notify("Dispatch disabled", "success")
    elseif wantedSetting == "mute" then
        disableNotis = false
        disableNotifSounds = true
        DenaliFW.Functions.Notify("Dispatch muted", "success")
    else
        DenaliFW.Functions.Notify('Please choose to have dispatch as "on", "off" or "mute".', "success")
...
RegisterNetEvent("denalifw-dispatch:client:AddCallBlip")
AddEventHandler("denalifw-dispatch:client:AddCallBlip", function(coords, data)
    ...
    while true do
        ...
        if IsExplosionInSphere(9, 1396.06, -746.13, 67.21, 99999.0) or IsExplosionInSphere(5, 1396.06, -746.13, 67.21, 99999.0) or IsExplosionInSphere(7, 1396.06, -746.13, 67.21, 99999.0) or IsExplosionInSphere(10, 1396.06, -746.13, 67.21, 99999.0) or IsExplosionInSphere(8, 1396.06, -746.13, 67.21, 99999.0) or IsExplosionInSphere(15, 1396.06, -746.13, 67.21, 99999.0) or IsExplosionInSphere(17, 1396.06, -746.13, 67.21, 99999.0) then
            if not AlertSend then
                exports['denalifw-dispatch']:Explosion()
                AlertSend = true
