maxVehiclePerformanceUpgrades = 2 -- Set to 0 to have all the upgrades
...
bennyGarages = {
   -- [1] = {coords = vector4(-212.75, -1316.039, -130.211, -180.73135375977), useJob = false, job = {"mechanic"}},
    [1] = {coords = vector4(-211.58, -1325.51, 30.48, 336.03), useJob = false, job = {"mechanic2"}},
    [2] = {coords = vector4(-340.09, -136.96, 38.6, 91.57), useJob = false, job = {"mechanic3"}},
    [3] = {coords = vector4(-110.97, -1798.74, 26.81, 229.36), useJob = false, job = {"mechanicGROVE"}},
    [4] = {coords = vector4(1167.5, 2642.87, 37.18, 2.23), useJob = false, job = {"mechanicroute68"}},
    [5] = {coords = vector4(145.3, -3030.08, 6.63, 178.35), useJob = false, job = {"mechanic5"}},
    [6] = {coords = vector4(937.11, -969.66, 39.17, 271.35), useJob = false, job = {"mechanic5"}},
    [7] = {coords = vector4(733.25, -1088.83, 21.54, 93.13), useJob = false, job = {"mechanic5"}},
    [8] = {coords = vector4(-90.74, -1806.25, 26.19, 226.2), useJob = false, job = {"mechanic5"}},
    [9] = {coords = vector4(-1155.0, -2006.27, 12.55, 334.39), useJob = false, job = {"mechanic5"}},
    [10] = {coords = vector4(110.37, 6627.37, 31.16, 222.35), useJob = false, job = {"mechanic5"}},
    [11] = {coords = vector4(-2162.09, 1155.66, -25.0, 272.84), useJob = false, job = {"mechanic5"}},
}

--[[bennyLocations = {
    vector4(-211.58, -1325.51, 30.48, 336.03),
    vector4(-340.09, -136.96, 38.6, 91.57), 
    vector4(-110.97, -1798.74, 26.81, 229.36), 
    vector4(1167.5, 2642.87, 37.18, 2.23), 
    vector4(145.3, -3030.08, 6.63, 178.35), 
    vector4(937.11, -969.66, 39.17, 271.35), 
    vector4(733.25, -1088.83, 21.54, 93.13), 
    vector4(-90.74, -1806.25, 26.19, 226.2), 
    vector4(-1155.0, -2006.27, 12.55, 334.39), 
    vector4(110.37, 6627.37, 31.16, 222.35), 
    vector4(-2162.09, 1155.66, -25.0, 272.84),
}]]
...
vehicleCustomisationPrices = {
    cosmetics = {price = 800},
    respray = {price = 1500},
    performance = {prices = {0, 15000, 30000, 60000, 110250, 120500}},
    turbo = {price = 45000},
    wheels = {price = 800},
    customwheels = {price = 1200},
    wheelsmoke = {price = 1800},
    windowtint = {price = 1400},
    neonside = {price = 1100},
    neoncolours = {price = 1500},
    headlights = {price = 1100},
    xenoncolours = {price = 1500},
