...
Config.Default_garage = 'pillboxgarage' -- what garage id ex. A , pillboxgarage (important to change this on some garage scripts like renzu_garage)
...
Config.JunkShop = {
	['Junk Shop'] = { -- <-- dont change -- this is where your players can buy vehicle shells aka junk vehicle for project cars
		label = 'Scrap Yard Parts', -- can change
...
Config.Paint = { -- paint initial price, Label, itemname, and rgb colors (this feature required your garage to support CustomColour)
    ...
    ['white'] = {label = 'Paint White', item = 'paint_white', price = 100, color = {255, 255, 255}},
}
