...
RestoreItem = function(use,model,matched)
	...
	if use and success then
		...
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "installed", "error")
		else
			TriggerEvent('DenaliFW:Notify', "installed", "error")
		end
	elseif not matched and Config.MetaInventory then
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "Wrong Part For This Car", "error")
		else
			TriggerEvent('DenaliFW:Notify', "Wrong Part For This Car", "error")
		end
	else
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "cancle", "error")
		else
			TriggerEvent('DenaliFW:Notify', "Cancle", "error")
		end
	end
...
InstallDoor = function()
	...
	elseif reason == 'alreadyinstall' then
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "Already Installed", "error")
		else
			TriggerEvent('DenaliFW:Notify', "Already Installed", "error")
		end
	else
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "to far away", "error")
		else
			TriggerEvent('DenaliFW:Notify', "to far away", "error")
		end
	end
...
InstallBonnet = function()
	...
	elseif status.engine == 1 then
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "Install Engine", "error")
		else
			TriggerEvent('DenaliFW:Notify', "Install Engine", "error")
		end
	elseif status.transmition == 1 then
		if Config.RenzuNotify then
			TriggerEvent('DenaliFW:Notify', "Install Transmission", "error")
		else
			TriggerEvent('DenaliFW:Notify', "Install Transmission", "error")
		end
	end
