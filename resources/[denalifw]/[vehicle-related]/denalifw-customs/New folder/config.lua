...
bennyGarages = {
    [1] = {coords = vector4(-212.75, -1316.039, 30.211, 180.73135375977), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
    [2] = {coords = vector4(-136.05, -3031.50, 7.04, 180.7938), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
    [3] = {coords = vector4(-326.58, -144.21, 39.02, 73.21), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
    [4] = {coords = vector4(-110.97, -1798.74, 26.81, 229.36), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
    [5] = {coords = vector4(1175.25, 2639.7, 37.75, 0.45), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
    [6] = {coords = vector4(937.34, -962.18, 39.13, 184.34), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
    [7] = {coords = vector4(135.68, -3029.6, 7.04, 175.97), useJob = true, job = {"mechanic", "mechanic1", "mechanic2", "mechanic3", "mechanic4", "mechanic5"}},
}

 --[[bennyLocations = {
    vector4(-212.75, -1316.039, 30.211, 180.73135375977),
    vector4(-136.05, -3031.50, 7.04, 180.7938),
    vector4(-323.0, -132.15, 38.96, 72.04),
    vector4(-110.97, -1798.74, 26.81, 229.36),
    vector4(1175.25, 2639.7, 37.75, 0.45),
    vector4(135.68, -3029.6, 7.04, 175.97),
}]]
