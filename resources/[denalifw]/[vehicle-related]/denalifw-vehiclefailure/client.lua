...
local function DamageRandomComponent()
	...
	exports['denalifw-mechanicjob']:SetVehicleStatus(DenaliFW.Functions.GetPlate(vehicle), randomComponent, exports['denalifw-mechanicjob']:GetVehicleStatus(DenaliFW.Functions.GetPlate(vehicle), randomComponent) - randomDamage)
end
					...
					if cfg.sundayDriver and GetVehicleClass(vehicle) ~= 14 then -- Not for boats
						...
						if speed >= 1.0 then
							...
							if brake > 127 then
								...
								exports['denalifw-mechanicjob']:SetVehicleStatus(DenaliFW.Functions.GetPlate(vehicle), "brakes", exports['denalifw-mechanicjob']:GetVehicleStatus(DenaliFW.Functions.GetPlate(vehicle), "brakes") - 0.01)
							end
