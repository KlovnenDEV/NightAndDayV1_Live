        ...
        while listening do
            ...
            for i = 1, #searched do
                ...
                if i == #searched and dumpsterFound then
                    DenaliFW.Functions.Notify('no good trash here', 'error')
                elseif i == #searched and not dumpsterFound then
                    DenaliFW.Functions.Notify('Dumpter diving')
                    ...
                    Citizen.Wait(1000)
                        ...
                        DenaliFW.Functions.Notify('You cancelled the search', 'error')
                    end)
                end
            end
        end
    ...
    while true do
        ...
        if canSearch then
            ...
            for i = 1, #dumpsters do
                ...
                if dist < 1.8 then
                    wait = 0
                    DrawText3Ds(dumpPos.x, dumpPos.y, dumpPos.z + 1.0, '[~g~E~w~]')
...
function startSearching(time, dict, anim, cb)
 ...
 --   DenaliFW.Functions.Progressbar("reful_boat", "Searching The dumpster..", 14000)
