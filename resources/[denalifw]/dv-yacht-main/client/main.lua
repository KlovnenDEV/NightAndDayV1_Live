...
RegisterNetEvent('dv_yacht:client:endstart', function()
  ...
  DenaliFW.Functions.Progressbar(Config.progressbartext[1], Config.progressbartext[1], math.random(3000, 10000), false, true, {
...
RegisterNetEvent('dv_yacht:client:takingmoney', function()
  if Config.framework == 'qb' then
    local DenaliFW = exports['denalifw-core']:GetCoreObject()
  DenaliFW.Functions.Progressbar(Config.progressbartext[2], Config.progressbartext[2], math.random(3000, 7000), false, true, {
    disableMovement = true,
    disableCarMovement = false,
    disableMouse = false,
    disableCombat = true,
...
RegisterNetEvent('dv_yacht:client:vehicle', function()
  if Config.framework == 'qb' then
      local DenaliFW = exports['denalifw-core']:GetCoreObject()
      DenaliFW.Functions.SpawnVehicle(Config.boatqb, function(veh)
