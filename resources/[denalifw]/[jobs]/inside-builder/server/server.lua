...
DenaliFW.Functions.CreateCallback('inside-builder:getexperience', function(source, cb, xPlayer)
    local PlayerData = DenaliFW.Functions.GetPlayer(source)
...
DenaliFW.Functions.CreateCallback('inside-builder:payout', function(source, cb, xPlayer, level)
    local PlayerData = DenaliFW.Functions.GetPlayer(source)
