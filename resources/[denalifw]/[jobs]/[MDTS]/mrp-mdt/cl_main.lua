...
function EnableGUI(enable)
    ...
    if enable then TriggerServerEvent('mrp-mdt:opendashboard') end
    SetNuiFocus(enable, enable)
    SendNUIMessage({ type = "show", enable = enable, job = 'police' })

    isOpen = enable
    TriggerEvent('mrp-mdt:animation')
end
...
AddEventHandler('mrp-mdt:animation', function()
...
RegisterNetEvent('mrp-mdt:dashboardbulletin')
AddEventHandler('mrp-mdt:dashboardbulletin', function(sentData)
    print(json.encode(sentData))
    SendNUIMessage({ type = "bulletin", data = sentData })
end)

RegisterNetEvent('mrp-mdt:dashboardWarrants')
AddEventHandler('mrp-mdt:dashboardWarrants', function(sentData)
    SendNUIMessage({ type = "warrants", data = sentData })
end)

RegisterNetEvent('mrp-mdt:dashboardReports')
AddEventHandler('mrp-mdt:dashboardReports', function(sentData)
    SendNUIMessage({ type = "reports", data = sentData })
end)

RegisterNetEvent('mrp-mdt:dashboardCalls')
AddEventHandler('mrp-mdt:dashboardCalls', function(sentData)
    SendNUIMessage({ type = "calls", data = sentData })
end)

RegisterNUICallback("deleteBulletin", function(data, cb)
    local id = data.id
    TriggerServerEvent('mrp-mdt:deleteBulletin', id)
    cb(true)
end)
...
RegisterNUICallback("newBulletin", function(data, cb)
    ...
    TriggerServerEvent('mrp-mdt:newBulletin', title, info, time, data.id)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:newBulletin')
AddEventHandler('mrp-mdt:newBulletin', function(ignoreId, sentData, job)
...
RegisterNetEvent('mrp-mdt:deleteBulletin')
AddEventHandler('mrp-mdt:deleteBulletin', function(ignoreId, sentData, job)
    if ignoreId == GetPlayerServerId(PlayerId()) then return end;
    if job == 'police' then
...
RegisterNetEvent('mrp-mdt:open')
AddEventHandler('mrp-mdt:open', function(jobLabel, lastname, firstname)
    open = true
    EnableGUI(open)
...
RegisterNUICallback("searchProfiles", function(data, cb)
    ...
    TriggerServerEvent('mrp-mdt:searchProfile', name)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:exitMDT')
AddEventHandler('mrp-mdt:exitMDT', function()
...
RegisterNetEvent('mrp-mdt:searchProfile')
AddEventHandler('mrp-mdt:searchProfile', function(sentData, isLimited)
    print(json.encode(sentData))
...
RegisterNUICallback("saveProfile", function(data, cb)
    ...
    TriggerServerEvent("mrp-mdt:saveProfile", profilepic, information, cid, fName, sName)
    cb(true)
end)

RegisterNUICallback("getProfileData", function(data, cb)
    local id = data.id
    TriggerServerEvent('mrp-mdt:getProfileData', id)
    cb(true)
end)

RegisterNUICallback("newTag", function(data, cb)
    if data.id ~= "" and data.tag ~= "" then
        TriggerServerEvent('mrp-mdt:newTag', data.id, data.tag)
    end
    cb(true)
end)
...
RegisterNUICallback("removeProfileTag", function(data, cb)
    ...
    TriggerServerEvent('mrp-mdt:removeProfileTag', cid, tagtext)
    cb(removeProfileTag)
end)

RegisterNetEvent('mrp-mdt:getProfileData')
AddEventHandler('mrp-mdt:getProfileData', function(sentData, isLimited)
...
RegisterNUICallback("updateLicence", function(data, cb)
    ...
    local cid = data.cid
    TriggerServerEvent('mrp-mdt:updateLicense', cid, type, status)
    cb(true)
end)
...
RegisterNUICallback("addGalleryImg", function(data, cb)
    local cid = data.cid
    local url = data.URL
    TriggerServerEvent('mrp-mdt:addGalleryImg', cid, url)
    cb(true)
end)
...
RegisterNUICallback("removeGalleryImg", function(data, cb)
    local cid = data.cid
    local url = data.URL
    TriggerServerEvent('mrp-mdt:removeGalleryImg', cid, url)
    cb(true)
end)

RegisterNUICallback("searchIncidents", function(data, cb)
    local incident = data.incident
    TriggerServerEvent('mrp-mdt:searchIncidents', incident)
    cb(true)
end)


RegisterNetEvent('mrp-mdt:getIncidents')
AddEventHandler('mrp-mdt:getIncidents', function(sentData)
...
RegisterNUICallback("getIncidentData", function(data, cb)
    local id = data.id
	print(id)
    TriggerServerEvent('mrp-mdt:getIncidentData', id)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getIncidentData')
AddEventHandler('mrp-mdt:getIncidentData', function(sentData, sentConvictions)
...
RegisterNUICallback("incidentSearchPerson", function(data, cb)
    local name = data.name
    TriggerServerEvent('mrp-mdt:incidentSearchPerson', name )
    cb(true)
end)

RegisterNetEvent('mrp-mdt:incidentSearchPerson')
AddEventHandler('mrp-mdt:incidentSearchPerson', function(sentData)
...
RegisterNUICallback("searchBolos", function(data, cb)
    ...
    TriggerServerEvent('mrp-mdt:searchBolos', searchVal)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getBolos')
AddEventHandler('mrp-mdt:getBolos', function(sentData)
    SendNUIMessage({ type = "bolos", data = sentData })
end)

RegisterNUICallback("getAllBolos", function(data, cb)
    TriggerServerEvent('mrp-mdt:getAllBolos')
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getAllIncidents')
AddEventHandler('mrp-mdt:getAllIncidents', function(sentData)
    SendNUIMessage({ type = "incidents", data = sentData })
end)

RegisterNUICallback("getAllIncidents", function(data, cb)
    TriggerServerEvent('mrp-mdt:getAllIncidents')
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getAllBolos')
AddEventHandler('mrp-mdt:getAllBolos', function(sentData)
    SendNUIMessage({ type = "bolos", data = sentData })
end)

RegisterNUICallback("getBoloData", function(data, cb)
    local id = data.id
    TriggerServerEvent('mrp-mdt:getBoloData', id)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getBoloData')
AddEventHandler('mrp-mdt:getBoloData', function(sentData)
...
RegisterNUICallback("newBolo", function(data, cb)
    ...
    local time = data.time
    TriggerServerEvent('mrp-mdt:newBolo', data)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:boloComplete')
AddEventHandler('mrp-mdt:boloComplete', function(sentData)
    SendNUIMessage({ type = "boloComplete", data = sentData })
end)

RegisterNUICallback("deleteBolo", function(data, cb)
    local id = data.id
    TriggerServerEvent('mrp-mdt:deleteBolo', id)
    cb(true)
end)

RegisterNUICallback("deleteICU", function(data, cb)
    local id = data.id
    TriggerServerEvent('mrp-mdt:deleteICU', id)
    cb(true)
end)
...
RegisterNUICallback("getAllReports", function(data, cb)
    TriggerServerEvent('mrp-mdt:getAllReports')
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getAllReports')
AddEventHandler('mrp-mdt:getAllReports', function(sentData)
    SendNUIMessage({ type = "reports", data = sentData })
end)

RegisterNUICallback("getReportData", function(data, cb)
    local id = data.id
    TriggerServerEvent('mrp-mdt:getReportData', id)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getReportData')
AddEventHandler('mrp-mdt:getReportData', function(sentData)
    SendNUIMessage({ type = "reportData", data = sentData })
end)

RegisterNUICallback("searchReports", function(data, cb)
    local name = data.name
    TriggerServerEvent('mrp-mdt:searchReports', name)
    cb(true)
end)

RegisterNUICallback("newReport", function(data, cb)
    TriggerServerEvent('mrp-mdt:newReport', data)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:reportComplete')
AddEventHandler('mrp-mdt:reportComplete', function(sentData)
...
RegisterNUICallback("searchVehicles", function(data, cb)
    local name = data.name
    TriggerServerEvent('mrp-mdt:searchVehicles', name)
    cb(true)
end)
...
RegisterNetEvent('mrp-mdt:searchVehicles')
AddEventHandler('mrp-mdt:searchVehicles', function(sentData)
    for i=1, #sentData do
...
RegisterNUICallback("getVehicleData", function(data, cb)
    local plate = data.plate
    TriggerServerEvent('mrp-mdt:getVehicleData', plate)
    cb(true)
end)
...
RegisterNetEvent('mrp-mdt:getVehicleData')
AddEventHandler('mrp-mdt:getVehicleData', function(sentData)
...
RegisterNUICallback("saveVehicleInfo", function(data, cb)
    ...
    TriggerServerEvent('mrp-mdt:saveVehicleInfo', dbid, plate, imageurl, notes)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:updateVehicleDbId')
AddEventHandler('mrp-mdt:updateVehicleDbId', function(sentData)
...
RegisterNUICallback("knownInformation", function(data, cb)
    ...
    local status = data.status
    local plate = data.plate
    TriggerServerEvent('mrp-mdt:knownInformation', dbid, type, status, plate)
    cb(true)
end)

RegisterNUICallback("getAllLogs", function(data, cb)
    TriggerServerEvent('mrp-mdt:getAllLogs')
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getAllLogs')
AddEventHandler('mrp-mdt:getAllLogs', function(sentData)
    SendNUIMessage({ type = "getAllLogs", data = sentData })
end)

RegisterNUICallback("getPenalCode", function(data, cb)
    TriggerServerEvent('mrp-mdt:getPenalCode')
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getPenalCode')
AddEventHandler('mrp-mdt:getPenalCode', function(titles, penalcode)
    SendNUIMessage({ type = "getPenalCode", titles = titles, penalcode = penalcode })
end)

RegisterNetEvent('mrp-mdt:getActiveUnits')
AddEventHandler('mrp-mdt:getActiveUnits', function(lspd, bcso, sahp, sasp, doc, sapr, pa, ems)
    SendNUIMessage({ type = "getActiveUnits", lspd = lspd, bcso = bcso, sahp = sahp, doc = doc, sasp = sasp, sapr = sapr, pa = pa, ems = ems })
end)

RegisterNUICallback("toggleDuty", function(data, cb)
    TriggerServerEvent('mrp-mdt:toggleDuty', data.cid, data.status)
    cb(true)
end)
...
RegisterNUICallback("saveIncident", function(data, cb)
    TriggerServerEvent('mrp-mdt:saveIncident', data)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:updateIncidentDbId')
AddEventHandler('mrp-mdt:updateIncidentDbId', function(sentData)
    SendNUIMessage({ type = "updateIncidentDbId", data = tonumber(sentData) })
end)

RegisterNUICallback("removeIncidentCriminal", function(data, cb)
    TriggerServerEvent('mrp-mdt:removeIncidentCriminal', data.cid, data.incidentId)
    cb(true)
end)
...
RegisterNUICallback("callDetach", function(data, cb)
    TriggerServerEvent('mrp-mdt:callDetach', data.callid)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:callDetach')
AddEventHandler('mrp-mdt:callDetach', function(callid, sentData)
...
RegisterNUICallback("callAttach", function(data, cb)
    TriggerServerEvent('mrp-mdt:callAttach', data.callid)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:callAttach')
AddEventHandler('mrp-mdt:callAttach', function(callid, sentData)
    -- local job = exports["rs_manager"]:isChar("myjob")
...
RegisterNUICallback("attachedUnits", function(data, cb)
    TriggerServerEvent('mrp-mdt:attachedUnits', data.callid)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:attachedUnits')
AddEventHandler('mrp-mdt:attachedUnits', function(sentData, callid)
    SendNUIMessage({ type = "attachedUnits", data = sentData, callid = callid })
end)

RegisterNUICallback("callDispatchDetach", function(data, cb)
    TriggerServerEvent('mrp-mdt:callDispatchDetach', data.callid, data.cid)
    cb(true)
end)

RegisterNUICallback("setDispatchWaypoint", function(data, cb)
    TriggerServerEvent('mrp-mdt:setDispatchWaypoint', data.callid, data.cid)
    cb(true)
end)

RegisterNUICallback("callDragAttach", function(data, cb)
    TriggerServerEvent('mrp-mdt:callDragAttach', data.callid, data.cid)
    cb(true)
end)

RegisterNUICallback("setWaypointU", function(data, cb)
    TriggerServerEvent('mrp-mdt:setWaypoint:unit', data.cid)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:setWaypoint:unit')
AddEventHandler('mrp-mdt:setWaypoint:unit', function(sentData) 
...
RegisterNUICallback("dispatchMessage", function(data, cb)
    TriggerServerEvent('mrp-mdt:sendMessage', data.message, data.time)
    cb(true)
end)
...
RegisterNetEvent('mrp-mdt:dashboardMessages')
AddEventHandler('mrp-mdt:dashboardMessages', function(sentData)
    SendNUIMessage({ type = "dispatchmessages", data = sentData })
end)

RegisterNUICallback("refreshDispatchMsgs", function(data, cb)
    TriggerServerEvent('mrp-mdt:refreshDispatchMsgs')
    cb(true)
end)
...
RegisterNUICallback("dispatchNotif", function(data, cb)
    ...
    if mentioned then
        TriggerEvent('mrp-phone:sendNotification', {img = info['profilepic'], title = "Dispatch (Mention)", content = info['message'], time = 7500, customPic = true })
        PlaySoundFrontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
        PlaySoundFrontend(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0)
    else
        TriggerEvent('mrp-phone:sendNotification', {img = info['profilepic'], title = "Dispatch ("..info['name']..")", content = info['message'], time = 5000, customPic = true })
    end
    cb(true)
end)

RegisterNUICallback("getCallResponses", function(data, cb)
    TriggerServerEvent('mrp-mdt:getCallResponses', data.callid)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:getCallResponses')
AddEventHandler('mrp-mdt:getCallResponses', function(sentData, sentCallId)
...
RegisterNUICallback("sendCallResponse", function(data, cb)
    TriggerServerEvent('mrp-mdt:sendCallResponse', data.message, data.time, data.callid)
    cb(true)
end)

RegisterNetEvent('mrp-mdt:sendCallResponse')
