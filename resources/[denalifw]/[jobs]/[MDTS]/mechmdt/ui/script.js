    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://mechmdt/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://mechmdt/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://mechmdt/performOffenderSearch', JSON.stringify({
        ...
        ForensicsSearch() {
            if (this.offender_search) {
                ...
                this.offender_results.query = this.offender_search;
                $.post('http://mechmdt/performForensicsSearch', JSON.stringify({
                    query: this.offender_search
                }));
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].citizenid) {
                    ...
                    $.post('http://mechmdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://mechmdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://mechmdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://mechmdt/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://mechmdt/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://mechmdt/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://mechmdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://mechmdt/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://mechmdt/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://mechmdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://mechmdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://mechmdt/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://mechmdt/sentencePlayer', JSON.stringify({
