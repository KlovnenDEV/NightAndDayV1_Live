    ...
    methods: {
        ...
        RespondCall() {
            $.post('http://drx_emsmdt/responCall', JSON.stringify({
                ...
                citizenid: this.current_call.citizenid,
        ...
        SelectPerson(citizenid, firstname, lastname, phone) {
            ...
            console.log(citizenid, firstname, lastname, phone)
            this.selected_person.citizenid = citizenid;
        },
        SubmitNewCase() {
            if (this.selected_person.citizenid || this.new_case.title || this.new_case.desc) {
                $.post('http://drx_emsmdt/submitNewCase', JSON.stringify({
                    citizenid: this.selected_person.citizenid,
        ...
        ViewCase(id, citizenid, patientName, author, title, desc) {
    ...
    if (document.readyState == 'complete') {
        window.addEventListener('message', (event) => {
            ...
            if (drx.update == 'returnPersonDatabase') {
                drx_emsmdt.returnPersonDatabase(drx.database, drx.firstname, drx.lastname, drx.phone)
            }
