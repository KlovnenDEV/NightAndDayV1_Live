const drx_mechanic = new Vue({
    ...
    data: () => ({
        ...
        Modifications: {
            ...
            Engine: {
                ...
                Level1: { Price: 15000, Label: 'Engine Level 1', Desc: 'This engine is tier 1', Image: 'images/Engine/engineC.png', Index: 11, Upgrade: 0 },
                Level2: { Price: 30000, Label: 'Engine Level 2', Desc: 'This engine is tier 2', Image: 'images/Engine/engineB.png', Index: 11, Upgrade: 1 },
                Level3: { Price: 45000, Label: 'Engine Level 3', Desc: 'This engine is tier 3', Image: 'images/Engine/engineA.png', Index: 11, Upgrade: 2 },
                Level4: { Price: 45000, Label: 'Engine Level 4', Desc: 'This engine is tier 4', Image: 'images/Engine/engineS.png', Index: 11, Upgrade: 3 },
            },
            Turbo: {
    ...
    methods: {
        ...
        // Updates
        ReturnSelectedVehicle(identifier, firstname, lastname, plate, mods) {
            ...
            // Engine
            if (mods.modEngine === 3) {
                this.SelectedVehicle.engine = 'Engine: S';
                this.CurrentEngine = 3;
                this.SelectedEngine = 3;
            } else if (mods.modEngine === 2) {
    ...
    if (document.readyState == 'complete') {
        window.addEventListener('message', (event) => {
            ...
            if (drx.update == 'returnDatabaseSelection') {
                drx_mechanic.ReturnSelectedVehicle(drx.identifier, drx.firstname, drx.lastname, drx.plate, drx.mods)
            }
