...
Config.Locations = {
    ["checking"] = {
	    [1] = vector3(308.95, -592.54, 43.28),
	    [2] = vector3(-256.06, 6329.19, 32.41), -- paleto
    },
    ["duty"] = {
        [1] = vector3(310.36, -602.95, 43.29),
    ...
    ["stash"] = {
        [1] = vector3(303.7, -600.48, 43.29),
    },
    ["beds"] = {
        [1] = {coords = vector4(311.14, -582.98, 44.20, 336.86), taken = false, model = 1631638868},
        [2] = {coords = vector4(314.53, -584.08, 44.20, 336.86), taken = false, model = 1631638868},
        [3] = {coords = vector4(317.72, -585.28, 44.20, 336.86), taken = false, model = 1631638868},
        [4] = {coords = vector4(319.28, -581.11, 44.20, 159.34), taken = false, model = 1631638868},
