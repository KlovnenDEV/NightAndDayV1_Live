...
Config.Locations = {
    ["checking"] = {
	    --[1] = vector3(1135.69, -1555.76, 35.41),-- St Face
	    [2] = vector3(-256.06, 6329.19, 32.41), -- paleto
    },
    ["duty"] = {
        [1] = vector3(1134.56, -1545.36, 35.41),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(1121.27, -1516.18, 34.69, 82.93),
        [2] = vector4(292.18, -584.41, 43.19, 346.05), --pillbox
    },
    ["helicopter"] = {
        [1] = vector4(1187.84, -1538.08, 39.4, 13.06),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(1133.67, -1570.73, 35.41),
        [2] = vector3(-245.13, 6315.71, 32.82),
    },
    ["roof"] = {
        [1] = vector4(1117.98, -1535.46, 52.14, 82.05),
    },
    ["main"] = {
        [1] = vector3(1144.18, -1574.76, 35.41),
    },
    ["stash"] = {
        [1] = vector3(1132.16, -1544.43, 35.41),
    },
    ["beds"] = {
        [1] = {coords = vector4(1132.95, -1568.44, 42.93, 359.99), taken = false, model = 1631638868},
        [2] = {coords = vector4(1132.95, -1561.39, 42.93, 359.99), taken = false, model = 1631638868},
        [3] = {coords = vector4(1132.95, -1554.44, 42.93, 359.99), taken = false, model = 1631638868},
        [4] = {coords = vector4(1132.96, -1547.4, 42.93, 359.99), taken = false, model = 1631638868},
        [5] = {coords = vector4(313.88, -579.08, 44.20, 159.34), taken = false, model = 1631638868},
	--- paleto
	    [9] = {coords = vector4(-260.2, 6319.18, 33.3, 32.84), taken = false, model = 2117668672},
        [10] = {coords = vector4(-261.68, 6317.35, 33.3, 43.36), taken = false, model = 2117668672},
        [11] = {coords = vector4(-266.35, 6320.02, 33.3, 225.24), taken = false, model = 2117668672},
    },
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(304.27, -600.33, 43.28, 272.249)},
        [2] = {label = ('Paleto Clinic'), coords = vector4(-245.81, 6324.29, 32.41, 331.47)}
    }
}
