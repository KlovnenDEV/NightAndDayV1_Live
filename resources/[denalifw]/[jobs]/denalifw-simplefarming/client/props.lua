...
RegisterNetEvent('denalifw-simplefarming:slaughter1', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedcow) then
        TriggerEvent('animations:client:EmoteCommandStart', {"Boxing2"})
        DenaliFW.Functions.Progressbar('killing_cow', Config.Alerts['killing_cow'], 12000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          ...
          disableCombat = true,
              ...
              TriggerServerEvent('denalifw-simplefarming:cowkilling')
    ...
    elseif not hasItem then
      DenaliFW.Functions.Notify(Config.Alerts['weapon'], "error", 3000)
    end
  end)
end)

RegisterNetEvent('denalifw-simplefarming:slaughter2', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedcow1) then
        TriggerEvent('animations:client:EmoteCommandStart', {"Boxing2"})
        DenaliFW.Functions.Progressbar('killing_cow', Config.Alerts['killing_cow'], 500, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          disableMovement = true,
          disableCarMovement = true,
          disableMouse = false,
          disableCombat = true,
...
RegisterNetEvent('denalifw-simplefarming:slaughter3', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedcow2) then
        TriggerEvent('animations:client:EmoteCommandStart', {"Boxing2"})
        DenaliFW.Functions.Progressbar('killing_cow', Config.Alerts['killing_cow'], 500, false, true, {
          disableMovement = true,
          disableCarMovement = true,
          disableMouse = false,
          disableCombat = true,
...
RegisterNetEvent('denalifw-simplefarming:slaughter4', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedcow3) then
        TriggerEvent('animations:client:EmoteCommandStart', {"Boxing2"})
        DenaliFW.Functions.Progressbar('killing_cow', Config.Alerts['killing_cow'], 5000, false, true, {
          disableMovement = true,
          disableCarMovement = true,
          disableMouse = false,
          disableCombat = true,
...
RegisterNetEvent('denalifw-simplefarming:killpig1', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedpig1) then
      TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic3"})
        DenaliFW.Functions.Progressbar('Killing_Pig', Config.Alerts['killing_pig'], 12000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          disableMovement = true,
          disableCarMovement = true,
          disableMouse = false,
          disableCombat = true,
            ...
            TriggerEvent('animations:client:EmoteCommandStart', {"c"})
            ClearPedTasks(PlayerPedId())
            TriggerServerEvent('denalifw-simplefarming:slayreward')
            TriggerServerEvent('hud:Server:GainStress', math.random(1, 2))
            Wait(1200000) -- 20 minutes
            pedpig1 = CreatePed(1, 0xB11BAB56, 2149.41, 5013.96, 41.39, 223.72, 0, false, true)
          end, function()
...
RegisterNetEvent('denalifw-simplefarming:killpig2', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig3', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig4', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig5', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig6', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig7', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig8', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig9', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig10', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig11', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig12', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig13', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig14', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig15', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('denalifw-simplefarming:killpig16', function()
  DenaliFW.Functions.TriggerCallback('denalifw-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
