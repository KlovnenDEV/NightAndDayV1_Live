### denalifw-RealEstate Job for DenaliFW! - Made by Aljo
...
# There are some things that need to be added to denalifw-houses, denalifw-clothing, denalifw-radialmenu and changed in denalifw-bossmenu

# denalifw-houses server/main.lua under Events

```lua

RegisterNetEvent('denalifw-houses:server:updateTier', function()
    local HouseGarages = {}
...
RegisterNetEvent('denalifw-houses:server:updatePrice', function(price)
...
RegisterNetEvent('denalifw-houses:server:deletehouses', function(selectedHouse)
    ...
    local src = source
    TriggerClientEvent('DenaliFW:Notify', src, "You deleted house: " .. label)
    
end)

```

# denalifw-houses client/main.lua under Events

```lua

RegisterNetEvent('denalifw-houses:client:deletehouses', function(selectedHouse)
...
# denalifw-clothing config.lua line 50
...
# denalifw-radialmenu config.lua line 572
