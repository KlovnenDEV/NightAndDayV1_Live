...
function EstateMenu()
    exports['denalifw-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                event = "denalifw-realestatejob:client:VehicleList"
            }
        },
        {
            header = "Close",
...
RegisterNetEvent("denalifw-realestatejob:client:VehicleList", function()
    local VehicleList = {
        {
            header = "Vehicle list",
            isMenuHeader = true
    ...
    for k, v in pairs(Config.Vehicles) do
        table.insert(VehicleList, {
            ...
            txt = "Take out",
            params = {
                event = "denalifw-realestatejob:client:SpawnListVehicle",
                args = k
            }
        })
    end
    ...
    exports['denalifw-menu']:openMenu(VehicleList)
end)

RegisterNetEvent("denalifw-realestatejob:client:SpawnListVehicle", function(model)
