            ...
            if skunk.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= baggieAmount then
                        ...
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_skunk_cbd_crop'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['empty_weed_bag'], "remove", returnAmount)
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_skunk_cbd', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_skunk_cbd"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You cut a crop of CBD Skunk!', 'success')
                                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                            end
                        end)
                    else
                        TriggerClientEvent('DenaliFW:Notify', src, "You need atleast 28 baggies..", 'error')
                        TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
                    end
                else
                    TriggerClientEvent('DenaliFW:Notify', src, "You dont have any baggies..", "error")
                    TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
                end
            else
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough CBD Skunk crops..", 'error')
                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any CBD Skunk crops..", "error")
            TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
        end
	elseif args == 2 then 
            ...
            if ogkush.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= baggieAmount then
						...
						Player.Functions.RemoveItem("empty_weed_bag", returnAmount)
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_og-kush_cbd_crop'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['empty_weed_bag'], "remove", returnAmount)
                        TriggerClientEvent('pogressBar:drawBar', src, packageTime, 'Trimming weed..')
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_og-kush_cbd', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_og-kush_cbd"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You cut a crop of CBD OG Kush!', 'success')
                                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                            end
                ...
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough CBD OG Kush crops..", 'error')
                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any CBD OG Kush crops..", "error")
            TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
        end
	elseif args == 3 then 
            ...
            if whitewidow.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= baggieAmount then
						...
						Player.Functions.RemoveItem("empty_weed_bag", returnAmount)
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_white-widow_cbd_crop'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['empty_weed_bag'], "remove", returnAmount)
                        TriggerClientEvent('pogressBar:drawBar', src, packageTime, 'Trimming weed..')
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_white-widow_cbd', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_white-widow_cbd"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You cut a crop of CBD White Widow!', 'success')
                                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                            end
                ...
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough CBD White Widow crops..", 'error')
                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any CBD White Widow crops..", "error")
            TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
        end
    elseif args == 4 then 
            ...
            if ak47.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= baggieAmount then
						...
						Player.Functions.RemoveItem("empty_weed_bag", returnAmount)
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_ak47_cbd_crop'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['empty_weed_bag'], "remove", returnAmount)
                        TriggerClientEvent('pogressBar:drawBar', src, packageTime, 'Trimming weed..')
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_ak47_cbd', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_ak47_cbd"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You cut a crop of CBD AK47!', 'success')
                                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                            end
                ...
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough CBD AK47 crops..", 'error')
                TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any CBD AK47 crops..", "error")
            TriggerClientEvent('case-whitewidow:client:TrimmingMenu', src)
        end
    end
end)
            ...
            if skunk.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= returnAmount then
                        ...
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_skunk_cbd'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['rolling_paper'], "remove", returnAmount)
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_skunk_cbd_joint', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_skunk_cbd_joint"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You rolled up some CBD Skunk!', 'success')
                        ...
                        TriggerClientEvent('DenaliFW:Notify', src, "You don't have enough rolling papers..", 'error')
                        TriggerClientEvent('case-whitewidow:client:RollJoints', src)
                    end
                else
                    TriggerClientEvent('DenaliFW:Notify', src, "You don't have any rolling papers..", "error")
                    TriggerClientEvent('case-whitewidow:client:RollJoints', src)
                end
            else
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough bags of CBD Skunk..", 'error')
                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any bags of CBD Skunk..", "error")
            TriggerClientEvent('case-whitewidow:client:RollJoints', src)
        end
	elseif args == 2 then 
            ...
            if ogkush.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= returnAmount then
						...
						Player.Functions.RemoveItem("rolling_paper", returnAmount)
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_og-kush_cbd'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['rolling_paper'], "remove", returnAmount)
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_og-kush_cbd_joint', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_og-kush_cbd_joint"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You rolled up some CBD OG-Kush!', 'success')
                                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                            end
                ...
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough bags of CBD OG-Kush..", 'error')
                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any bags of CBD OG-Kush..", "error")
            TriggerClientEvent('case-whitewidow:client:RollJoints', src)
        end
	elseif args == 3 then 
            ...
            if whitewidow.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= returnAmount then
						...
						Player.Functions.RemoveItem("rolling_paper", returnAmount)
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_white-widow_cbd'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['rolling_paper'], "remove", returnAmount)
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_white-widow_cbd_joint', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_white-widow_cbd_joint"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You rolled up some CBD White-Widow!', 'success')
                                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                            end
                ...
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough bags of CBD White-Widow..", 'error')
                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any bags of CBD White-Widow..", "error")
            TriggerClientEvent('case-whitewidow:client:RollJoints', src)
        end
    elseif args == 4 then 
            ...
            if ak47.amount >= removeAmount then
                ...
                if baggies ~= nil then
                    if baggies.amount >= returnAmount then
						...
						Player.Functions.RemoveItem("rolling_paper", returnAmount)
                        TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['weed_ak47_cbd'], "remove", removeAmount)
						TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items['rolling_paper'], "remove", returnAmount)
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_ak47_cbd_joint', returnAmount, nil, info, {["quality"] = 100}) then
                                TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_ak47_cbd_joint"], "add", returnAmount)
								TriggerClientEvent('DenaliFW:Notify', src, 'You cut a crop of CBD AK47!', 'success')
                                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
                            else
                                TriggerClientEvent('DenaliFW:Notify', src, 'Your pockets are full..', 'error')
                ...
                TriggerClientEvent('DenaliFW:Notify', src, "You dont have enough bags of CBD AK-47..", 'error')
                TriggerClientEvent('case-whitewidow:client:RollJoints', src)
            end
        else
            TriggerClientEvent('DenaliFW:Notify', src, "You dont have any bags of CBD AK-47..", "error")
            TriggerClientEvent('case-whitewidow:client:RollJoints', src)
        end
    end
end)
...
RegisterServerEvent('case-whitewidowjob:server:HarvestSkunk', function() 
	...
	if (85 >= math.random(1, 100)) then
        if Player.Functions.AddItem("weed_skunk_cbd_crop", 1, slot, {["quality"] = 100}) then
			TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_skunk_cbd_crop"], "add", quantity)
			TriggerClientEvent('DenaliFW:Notify', src, 'You successfully harvested a cbd skunk plant!', 'success')
		end	
	else
        TriggerClientEvent('DenaliFW:Notify', src, 'You damaged the plant trying to harvest..', 'error')
	end
end)
...
RegisterServerEvent('case-whitewidowjob:server:HarvestOGKush', function() 
	...
	if (30 >= math.random(1, 100)) then
        if Player.Functions.AddItem("weed_og-kush_cbd_crop", 1, slot, {["quality"] = 100}) then
			TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_og-kush_cbd_crop"], "add", quantity)
			TriggerClientEvent('DenaliFW:Notify', src, 'You successfully harvested a cbd og-kush plant!', 'success')
		end
	else
        TriggerClientEvent('DenaliFW:Notify', src, 'You damaged the plant trying to harvest..', 'error')
	end
...
RegisterServerEvent('case-whitewidowjob:server:HarvestWhiteWidow', function() 
	...
	if (75 >= math.random(1, 100)) then
        if  Player.Functions.AddItem("weed_white-widow_cbd_crop", 1, slot, {["quality"] = 100}) then
			TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_white-widow_cbd_crop"], "add", quantity)
			TriggerClientEvent('DenaliFW:Notify', src, 'You successfully harvested a cbd white-widow plant!', 'success')
		end	
	else
        TriggerClientEvent('DenaliFW:Notify', src, 'You damaged the plant trying to harvest..', 'error')
	end
...
RegisterServerEvent('case-whitewidowjob:server:HarvestAK47', function() 
	...
	if (10 >= math.random(1, 100)) then
        if Player.Functions.AddItem("weed_ak47_cbd_crop", 1, slot, {["quality"] = 100}) then
			TriggerClientEvent('inventory:client:ItemBox', src, DenaliFW.Shared.Items["weed_ak47_cbd_crop"], "add", quantity)
			TriggerClientEvent('DenaliFW:Notify', src, 'You successfully harvested a cbd ak47 plant!', 'success')
		end	
	else
        TriggerClientEvent('DenaliFW:Notify', src, 'You damaged the plant trying to harvest..', 'error')
	end
...
AddEventHandler('case-whitewidowjob:server:SpawnVehicle', function()
		...
		if carprice >= Config.VehicleDeposit then
			...
			TriggerClientEvent('DenaliFW:Notify', src, 'You need $'..Config.VehicleDeposit..' to take out a vehicle', "error")   
		end
end)
...
-- Use joints
DenaliFW.Functions.CreateUseableItem("weed_skunk_cbd_joint", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
...
DenaliFW.Functions.CreateUseableItem("weed_og-kush_cbd_joint", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
...
DenaliFW.Functions.CreateUseableItem("weed_white-widow_cbd_joint", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
...
DenaliFW.Functions.CreateUseableItem("weed_ak47_cbd_joint", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
