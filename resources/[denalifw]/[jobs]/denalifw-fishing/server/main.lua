...
DenaliFW.Functions.CreateCallback('fishing:GetItemData', function(source, cb, itemName)
	local retval = false
...
DenaliFW.Functions.CreateUseableItem("fishingrod", function(source, item)
    local Player = DenaliFW.Functions.GetPlayer(source)
...
AddEventHandler("fishing:sellFish", function()
    ...
    if Player.PlayerData.items ~= nil and next(Player.PlayerData.items) ~= nil then 
		...
		TriggerClientEvent('DenaliFW:Notify', src, "You have sold your fish")
	end
end)
