...
Config.Locations = {
   ...
   --[["roost"] = {
        ...
        ["type"] = "normal",
        ["coords"] = {
            [1] = vector3(-171.65, 302.8, 98.52)

        },
        ["products"] = Config.Products["roost"],
        ["showblip"] = true,
    },]]
    ["resutraunt"] = {
        ["label"] = "Salieri's Restaurant",
        ["type"] = "normal",
        ["coords"] = {
            [1] = vector3(417.95, -1494.44, 30.16),
            [2] = vector3(415.34, -1492.58, 29.91),
            [3] = vector3(413.57, -1493.71, 29.89),
            [4] = vector3(411.61, -1494.95, 29.89)
