...
- [DenaliFW framework](https://github.com/DenaliFW-framework)
- [denalifw-menu](https://github.com/DenaliFW-framework/denalifw-menu)
- [DenaliFW inventory](https://github.com/DenaliFW-framework/denalifw-inventory)
- [lj-inventory](https://github.com/loljoshie/lj-inventory) -- in screenshot
- [denalifw-shops](https://github.com/DenaliFW-framework/denalifw-shops)

# step 2: add items

-- Add this code at end of denalifw-core\shared\items.lua
...
# step 3: denalifw-shop

- Here is tables denalifw-shops/config.lua
