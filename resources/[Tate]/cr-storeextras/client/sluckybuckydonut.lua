...
AddEventHandler('cr-storeextras:client:SluckyBuckyDonut', function()
    ...
    DenaliFW.Functions.TriggerCallback('cr-storeextras:server:SluckyBuckyDonutCooldown', function(result)
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    DenaliFW.Functions.Progressbar("slucky_bucky_donut", "Grabbing a Super Donut!", 10000, false, true, {
