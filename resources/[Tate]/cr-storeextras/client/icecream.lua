...
AddEventHandler('cr-storeextras:client:VanillaIceCream', function()
    ...
    DenaliFW.Functions.TriggerCallback('cr-storeextras:server:IceCreamCooldown', function(result)
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    DenaliFW.Functions.Progressbar("vanilla_icecream", "Scooping some Vanilla Ice Cream...", 10000, false, true, {
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true) -- Change Emote
                    DenaliFW.Functions.Progressbar("chocolate_icecream", "Scooping some Chocolate Ice Cream...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true) -- Change Emote
                    DenaliFW.Functions.Progressbar("mint_icecream", "Scooping some Mint Ice Cream...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true) -- Change Emote
                    DenaliFW.Functions.Progressbar("cookiesandcream_icecream", "Scooping some Cookies & Cream Ice Cream...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
