...
function StoreExtraNotifications(notifType, message, title)
	if Config.Notify == "qb" then
		if notifType == 1 then
			DenaliFW.Functions.Notify(message, 'success')
		elseif notifType == 2 then
			DenaliFW.Functions.Notify(message, 'primary')
		elseif notifType == 3 then
			DenaliFW.Functions.Notify(message, 'error')
		end
...
Citizen.CreateThread(function()
    exports['denalifw-target']:AddTargetModel(slushy,{
        options = {
            {
                type = "client",
    ...
    exports['denalifw-target']:AddTargetModel(sluckyduckydonut, {
        options = {
            {
                type = "client",
    ...
    exports['denalifw-target']:AddTargetModel(icecream, {
        options = {
            {
                type = "client",
    ...
    exports['denalifw-target']:AddTargetModel(gumballstand, {
        options = {
            {
                type = "client",
