...
AddEventHandler('cr-storeextras:client:RedSlushy', function()
    ...
    DenaliFW.Functions.TriggerCallback('cr-storeextras:server:SlushyCooldown', function(result)
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    DenaliFW.Functions.Progressbar("red_slushy", "Pouring a Red Slushy...", 10000, false, true, {
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true)
                    DenaliFW.Functions.Progressbar("green_slushy", "Pouring a Green Slushy...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true)
                    DenaliFW.Functions.Progressbar("orange_slushy", "Pouring a Orange Slushy...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true)
                    DenaliFW.Functions.Progressbar("yellow_slushy", "Pouring a Yellow Slushy...", 10000, false, true, {
                       disableMovement = true,
                       disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true)
                    DenaliFW.Functions.Progressbar("blue_slushy", "Pouring a Blue Slushy...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
        ...
        if not result then
            if Config.Minigame == true then
                ...
                if success then
                    ...
                    TaskStartScenarioInPlace(ped, "WORLD_HUMAN_HANG_OUT_STREET", 0, true)
                    DenaliFW.Functions.Progressbar("rainbow_slushy", "Pouring a Rainbow Slushy...", 10000, false, true, {
                        disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
