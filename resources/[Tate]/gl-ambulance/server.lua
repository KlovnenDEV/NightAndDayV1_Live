...
RegisterServerEvent("gl-ambulance:getItemForEMS", function(itemname)
    ...
    if not item or item.amount < 1 then
        ...
        TriggerClientEvent("inventory:client:ItemBox", src, DenaliFW.Shared.Items[itemname], "add", 1)
    end
end)
...
RegisterServerEvent("gl-ambulance:treatPlayerWounds", function(playerid, wound)
    ...
    if wound == "bullet" then
        ...
        TriggerClientEvent("inventory:client:ItemBox", Player.PlayerData.source, DenaliFW.Shared.Items["recoveredbullet"], "add", 1)
    end
end)

RegisterServerEvent("gl-ambulance:checkPlayerWounds", function(target, wound)
    local src = source
    local targetPlayer = DenaliFW.Functions.GetPlayer(target)
...
RegisterServerEvent("gl-ambulance:revivePlayer", function(target, type)
    ...
    if type == 'grandma' and Config.GrandmasCost > 0 then
        ...
        --    TriggerClientEvent("hospital:client:Revive", targetPlayer.PlayerData.source)
            ...
            TriggerClientEvent("DenaliFW:Notify", targetPlayer.PlayerData.source, "You don't have enough money sonny", "error")
        end
    elseif type == 'nancy' and Config.NancyCost > 0 then
        ...
        elseif targetPlayer.Functions.RemoveMoney("bank", Config.NancyCost) then 
            ...
            TriggerClientEvent("DenaliFW:Notify", targetPlayer.PlayerData.source, "You don't have enough money", "error")
        end
...
RegisterServerEvent("gl-ambulance:delStretcher", function(netId)
    ...
    TriggerClientEvent("inventory:client:ItemBox", src, DenaliFW.Shared.Items["stretcher"], "add", 1)
...
RegisterServerEvent("gl-ambulance:putInVehicle", function(target, vehicle)
    local Player = DenaliFW.Functions.GetPlayer(target)
...
RegisterServerEvent("gl-ambulance:bodyBag", function(targetid)
    ...
    if Player.Functions.GetItemByName("bodybag") ~= nil then
        if Target.PlayerData.metadata["isdead"] then
            ...
            TriggerClientEvent("inventory:client:ItemBox", src, DenaliFW.Shared.Items["bodybag"], "remove", 1)
...
RegisterServerEvent("gl-ambulance:reportPulseBack", function(target, pulse, status)
    TriggerClientEvent("DenaliFW:Notify", target, "Pulse: " .. pulse, "primary", 15000)
    TriggerClientEvent("DenaliFW:Notify", target, status, "primary", 15000)
end)
...
RegisterServerEvent("gl-ambulance:removeDefib", function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", src, DenaliFW.Shared.Items["defib"], "remove", 1)
end)
...
RegisterServerEvent("gl-ambulance:giveWheelchair", function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", src, DenaliFW.Shared.Items["wheelchair"], "add", 1)
end)
...
DenaliFW.Functions.CreateCallback("gl-ambulance:isPlayerDead", function(source, cb, playerid)
    local Player = DenaliFW.Functions.GetPlayer(playerid)
...
-- Items
DenaliFW.Functions.CreateUseableItem("tweezers", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
...
DenaliFW.Functions.CreateUseableItem("suturekit", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
...
DenaliFW.Functions.CreateUseableItem("burncream", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
...
DenaliFW.Functions.CreateUseableItem("defib", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
...
DenaliFW.Functions.CreateUseableItem("bodybag", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
...
DenaliFW.Functions.CreateUseableItem("medbag", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
        Player.Functions.RemoveItem(item.name, 1)
        TriggerClientEvent("inventory:client:ItemBox", src, DenaliFW.Shared.Items[item.name], "remove", 1)
        TriggerClientEvent("gl-ambulance:useMedBag", src)
    end
end)

DenaliFW.Functions.CreateUseableItem("sedative", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
        Player.Functions.RemoveItem(item.name, 1)
...
DenaliFW.Functions.CreateUseableItem("stretcher", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
        Player.Functions.RemoveItem(item.name, 1)
...
DenaliFW.Functions.CreateUseableItem("medikit", function(source, item)
    local src = source
    local Player = DenaliFW.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
