...
local function CheckForVehicles()
    ...
    for k, v in pairs(Config.AllowedStretcherVehicles) do
        vehicle = DenaliFW.Functions.GetClosestVehicle(PlayerPos)
...
RegisterNetEvent('gl-ambulance:useStretcher', function()
    ...
    DenaliFW.Functions.LoadModel(hash)
    ...
    if stretcher ~= nil or stretcher ~= 0 then
        ...
        DenaliFW.Functions.RequestAnimDict("anim@heists@box_carry@")
...
RegisterNetEvent('gl-ambulance:putOnStretcher', function()
    ...
    if DoesEntityExist(closestObject) then
        local objCoords = GetEntityCoords(closestObject)
        DenaliFW.Functions.RequestAnimDict("anim@gangops@morgue@table@")
...
RegisterNetEvent('gl-ambulance:useItem', function(itemName)
    ...
    if itemName == 'medikit' then
        ...
        DenaliFW.Functions.RequestAnimDict(lib)
        ...
        DenaliFW.Functions.Notify('You have used 1x MediKit', 'success', 2000)
    end
end)
...
RegisterNetEvent('gl-ambulance:sendPulseBack', function(target)
    ...
    DenaliFW.Functions.TriggerCallback('gl-ambulance:isPlayerDead', function(isdead)
        if isdead then
            minPulse = 0
            maxPulse = 0
            status = 'No heartbeat'
...
RegisterNetEvent('gl-ambulance:treatAnimations', function(wound)
    ...
    if wound == 'bullet' then
        DenaliFW.Functions.RequestAnimDict("mini@repair")
...
RegisterNetEvent('gl-ambulance:goNightNight', function()
    local ped = PlayerPedId()
    DenaliFW.Functions.RequestAnimDict('mini@cpr@char_b@cpr_def')
...
RegisterNetEvent('gl-ambulance:spawnPed', function(coords, heading)
    ...
    SetModelAsNoLongerNeeded(hash)
    exports['denalifw-target']:AddEntityZone('nancy', npc, {
        name = "nancy",
...
RegisterNetEvent('gl-ambulance:checkInNancy', function()
    ...
    DenaliFW.Functions.Notify('You have been moved to a bed for Treatment.', 'success')
    ...
    ClearPedTasks(ped)
    DenaliFW.Functions.Notify('You are good now, stop getting in trouble.', 'success')
end)
...
RegisterNetEvent('gl-ambulance:spawnGrandmaPed', function(coords, heading)
    ...
    SetModelAsNoLongerNeeded(hash)
    exports['denalifw-target']:AddEntityZone('grandma', grandma, {
        name = "grandma",
...
RegisterNetEvent('gl-ambulance:useGrandmas', function()
    DenaliFW.Functions.Notify('I\'ll take care of you sonny', 'primary', 5000)
    Wait(5000)
...
RegisterNetEvent('gl-ambulance:tryRevivePlayer', function()
    ...
    if player ~= -1 and distance <= 3.0 then
        if PlayerJob.name == 'ambulance' or PlayerJob.name == 'police' then
            ...
            DenaliFW.Functions.TriggerCallback('gl-ambulance:isPlayerDead', function(isdead)
                if isdead then
                    DenaliFW.Functions.RequestAnimDict('anim@gangops@facility@servers@bodysearch@')
            ...
            DenaliFW.Functions.TriggerCallback('gl-ambulance:isPlayerDead', function(isdead)
                if isdead then
                    ...
                    if doMath <= 20 then
                        ...
                        DenaliFW.Functions.Notify('You failed to work the defibrillator and broke it.', 'error')
                    end
...
RegisterNetEvent('gl-ambulance:useWheelChair', function()
    local ped = PlayerPedId()
    local pedCoords = GetEntityCoords(ped)
    DenaliFW.Functions.SpawnVehicle('wheelchair', function(veh)
...
RegisterNetEvent('gl-ambulance:useTheBed', function()
    ...
    DenaliFW.Functions.Notify('You have been moved to a bed for Treatment.')
...
CreateThread(function()
    ...
    -- Medical Bag
    exports['denalifw-target']:AddTargetModel(medical, {
        options = {{
    ...
    -- Body Bag
    exports['denalifw-target']:AddTargetModel(bodybag, {
        options = {{
    ...
    exports['denalifw-target']:AddGlobalVehicle({
        options = {{
            ...
            action = function(entity)
                ...
                local player, distance = DenaliFW.Functions.GetClosestPlayer(coords)
            ...
            action = function(entity)
                ...
                if playerInWheelChair == 0 then
                    ...
                    if DoesEntityExist(entity) then
                        DenaliFW.Functions.DeleteVehicle(entity)
    ...
    -- Stretcher
    exports['denalifw-target']:AddTargetModel(stretch, {
        options = {{
    ...
    if Config.UseBeds then
        ...
        exports['denalifw-target']:AddTargetModel(pillboxBeds, {
            options = {{
