...
RegisterNetEvent('Admin:Fix:Vehicle', function(Result)
    ...
    if IsPedInAnyVehicle(PlayerPedId(), false) then
        ...
        local Vehicle, Distance = DenaliFW.Functions.GetClosestVehicle(GetEntityCoords(PlayerPedId()))
...
RegisterNetEvent('Admin:Spawn:Vehicle', function(Result)
    ...
    TriggerEvent('DenaliFW:Command:SpawnVehicle', Result['model'])
end)
...
RegisterNetEvent('Admin:Teleport:Marker', function(Result)
    ...
    TriggerEvent('DenaliFW:Command:GoToMarker')
end)
...
RegisterNetEvent("mc-admin/client/toggle-godmode", function()
    ...
    DenaliFW.Functions.Notify('Godmode '..Msg, MsgType)
