...
2. Go to your denalifw-core/server/player.lua, and find `DenaliFW.Player.CheckPlayerData function` and paste this snippets
...
3. Go to your denalifw-core/shared/items.lua, and add this
...
4. Go to your `denalifw-radialmenu/config.lua` and add this on policejob, probably line 711
...
5. Go to your `denalifw-vehicleshop/server.lua` find this event `denalifw-vehicleshop:server:buyShowroomVehicle`, replace that with
