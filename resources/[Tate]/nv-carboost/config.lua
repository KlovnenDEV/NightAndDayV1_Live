...
Config.Alert = 'denalifw-dispatch' -- denalifw-dispatch / linden_outlawalert / notification, only use denalifw-dispatch when its on stable release

Config.Inventory = 'denalifw-inventory/html/images/' -- denalifw-inventory/html/images/
