...
Config.RosterLink = {
    ['police'] = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vT3iyRcdCTfXL8aI_EAAoFiXZKAGHvuVdzUYEfoYhYGH7EmGA1aloYMFo1kd-aK5uEd7jzKrJzcv4M2/pubhtml',
    ['ambulance'] = '',
    ['bcso'] = 'https://docs.google.com/spreadsheets/d/1uiVa-I1Q3-Dp-jMEebHQziOPZjqQIvvtqpJi7ueQglY/edit?usp=sharing',
    ['doj'] = '',
}
...
-- this is a hack, because the denalifw-menu in denalifw-policejob populates an impound location and passed it through to the event.
-- if this impound locations are changed in denalifw-policejob, they must also be changed here.
