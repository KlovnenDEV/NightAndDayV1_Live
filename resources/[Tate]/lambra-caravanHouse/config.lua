Config = {}
Config.CorePrefix = "denalifw-"

Config.QBTarget = "denalifw-target" --"none" if you don't want to use target else set your target resource name for example "qb-target"
