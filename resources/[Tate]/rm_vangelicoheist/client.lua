...
function VangelicoStart()
    DenaliFW.Functions.TriggerCallback('vangelicoheist:server:checkPoliceCount', function(status)
        if status then
            DenaliFW.Functions.TriggerCallback('vangelicoheist:server:checkTime', function(time)
                if time then
...
function PaintingScene(sceneId)
    ...
    DenaliFW.Functions.TriggerCallback('vangelicoheist:server:hasItem', function(hasItem, itemLabel)
        if hasItem then
