...
export const SharedConfig = {
    ...
    Animals: {
        COW: {
            ...
            ageDecrease_default: 0.5,
            ageDecrease_thirstMultiplier: 0.04,
            ageDecrease_hungerMultiplier: 0.02,
            ageDecrease_healthMultiplier: 0.05,
        ...
        PIG: {
            ...
            weight_HungerMultiplier: 0.003,
            weight_ThirstMultiplier: 0.0015,
            weight_HealthMultiplier: 0.001,
            weight_ageMultiplier: 0.001,

            ageDecrease_default: 0.4,
            ageDecrease_thirstMultiplier: 0.03,
            ageDecrease_hungerMultiplier: 0.06,
