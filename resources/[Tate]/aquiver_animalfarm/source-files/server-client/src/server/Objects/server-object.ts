...
export class AquiverObject
{
    ...
    {
        if (typeof this._data.rotation === 'undefined') this._data.rotation = new Vector3Mp(0, 0, 0);
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-append', this.data);
        ...
        this._data.variables = new Proxy(this._data.variables, {
            set: (self, key, value) =>
            {
                ...
                sdk.players.TriggerAllClientDimension(this.dimension, 'object-set-var', this.id, key, value);
                self[key] = value;
                return true;
            },
        });
    ...
    set collision(state: boolean)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'collision', this.collision);
    }
    get alpha()
    {
    ...
    set alpha(amount: number)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'alpha', this.alpha);
    }
    get freezed()
    {
    ...
    set freezed(state: boolean)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'freezed', this.freezed);
    }
    get rotation()
    {
    ...
    set rotation(rot: Vector3Mp)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'rotation', this.rotation);
    }
    get model()
    {
    ...
    set model(model: string)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'model', this.model);
    }
    get position()
    {
    ...
    set position(v3: Vector3Mp)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'position', this.position);
    }
    get dimension()
    {
    ...
    set dimension(dim: number)
    {
        ...
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-update-data', this.id, 'dimension', this.dimension);
    }
    get variables()
    {
    ...
    destroy()
    {
        sdk.players.TriggerAllClientDimension(this.dimension, 'object-remove', this.id);
...
export const { ServerObjects, at, create, exist, generateId, initOnDimensionChange } = ObjectManager;