            ...
            this.object.interactionPress = async (Player) =>
            {
                try {
                    if(Player.hasAttachment('foodBag')) {
                        if (this.foodAmount >= SharedConfig.AnimalFarm.maximumFood)
                            return Player.Notification(TSL.list.trough_already_filled);
                        ...
                        if (newFood > SharedConfig.AnimalFarm.maximumFood)
                            newFood = SharedConfig.AnimalFarm.maximumFood;
