...
export const ObjectManager = new class
{
    ...
    constructor()
    {
        ...
        onNet('spawn-upgrade-object', (d: { rotation: Vector3Mp; position: Vector3Mp; model: string }) =>
        {
    ...
    start() {
        if(!this._interval) {
            this._interval = setInterval(() =>{
                ...
                {
                    return sdk.methods.dist(sdk.localPlayer.position, v.position) < SharedConfig.ObjectManager.TextDistance;
                }));
    ...
    SpawnUpgradeObject(rotation: Vector3Mp, position: Vector3Mp, model: string)
    {
                ...
                this.TextDistanceObjects.forEach(a =>
                {
                    if (typeof a.variables.foodAmount !== 'undefined')
                    {
                        sdk.methods.DrawText3D(
                            new Vector3Mp(a.position.x, a.position.y, a.position.z + 0.85),
                    ...
                    if(typeof a.variables.constantName !== 'undefined') {
                        sdk.methods.DrawText3D(
                            new Vector3Mp(a.position.x, a.position.y, a.position.z + 0.55),
                    ...
                    {
                        sdk.methods.DrawText3D(
                            new Vector3Mp(a.position.x, a.position.y, a.position.z + 1),
                    ...
                    {
                        sdk.methods.DrawText3D(
                            new Vector3Mp(a.position.x, a.position.y, a.position.z + 1.7),
