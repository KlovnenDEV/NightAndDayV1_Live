...
DP.Walks = {
  ...
  ["Trevor"] = {"move_p_m_two"},
  ["Wide"] = {"move_m@bag"},
  -- I cant get these to work for some reason, if anyone knows a fix lmk8x Development | 8xdev.com | Prenses Baran | https://discord.gg/fandgwjNUm
  --["Caution"] = {"move_m@caution"},
  --["Chubby"] = {"anim@move_m@chubby@a"},
  --["Crazy"] = {"move_m@crazy"},
  --["Joy"] = {"move_m@joy@a"},8x Development | 8xdev.com | Prenses Baran | https://discord.gg/fandgwjNUm
  --["Power"] = {"move_m@power"},
...
DP.Emotes = {
   ["eastside2"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@bodhi@rds@base", "idle_a", "Eastside Sign 2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["eastside3"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@low@ps@base", "idle_a", "Eastside Sign 3 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["eastside4"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@std@ds@base", "idle_a", "Eastside Sign 4 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["vsign"] = {"amb@code_human_in_car_mp_actions@v_sign@bodhi@rps@base", "idle_a", "V Sign ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["docker"] = {"anim@mp_player_intupperdock", "idle_a", "Docker ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["checkwatch"] = {"amb@code_human_wander_idles_fat@male@idle_a", "idle_a_wristwatch", "Check Watch ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["fixthelamp"] = {"amb@prop_human_movie_bulb@idle_a", "idle_a", "Fix the Lamp ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }},
   ["leanside6"] = {"amb@prop_human_seat_sunlounger@female@base", "base", "Leanside 6 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true, 
   }}, 
   ["sleep2"] = {"amb@world_human_bum_slumped@male@laying_on_left_side@base", "base", "Sleep 2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["flexmuscles"] = {"amb@world_human_muscle_flex@arms_at_side@idle_a", "idle_a", "Flex Muscles ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["cashier"] = {"anim@heists@fleeca_bank@scope_out@cashier_loop", "cashier_loop", "Cashier ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
   }}, 
   ["sit10"] = {"anim@heists@narcotics@funding@gang_chat", "gang_chatting_combined", "Sit 10 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["scaredground"] = {"anim@heists@ornate_bank@hostages@cashier_b@", "flinch_loop_underfire", "Scared Ground ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitinjured"] = {"anim@heists@prison_heistig_5_p1_rashkovsky_idle", "idle_180", "Sit Injured ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["flickoff"] = {"anim@mp_player_intcelebrationfemale@finger", "finger", "Flickoff ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["handsupsit"] = {"anim@mp_rollarcoaster", "hands_up_idle_a_player_one", "Handsup Sit ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }}, 
   ["gangaim"] = {"combat@aim_variations@1h@gang", "aim_variation_b", "Gang Aim ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["injuredaim"] = {"combat@damage@injured_pistol@to_writhe", "variation_b", "Injured Aim ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["injuredaim2"] = {"combat@damage@writhe", "writhe_loop", "Injured Aim 2 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }}, 
   ["cracksafe"] = {"mini@safe_cracking", "dial_turn_anti_slow", "Cracksafe ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["leanside7"] = {"mini@strip_club@backroom@", "leadin_loop_idle_c_stripper_c", "Leanside 7 ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["flashtease"] = {"mini@strip_club@backroom@", "stripper_b_backroom_idle_b", "Flashtease ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }}, 
   ["checkcat"] = {"mini@strip_club@backroom@", "stripper_c_leadin_backroom_idle_a", "Check Cat ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["shakeboobs"] = {"mini@strip_club@idles@stripper", "stripper_idle_05", "Shake Boobs ~p~ NEW", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},  
