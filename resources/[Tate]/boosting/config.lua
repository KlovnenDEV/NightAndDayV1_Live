...
Config['General'] = {
    ...
    ["Core"] = "DenaliFW", -- This can be ESX , DenaliFW , NPBASE
    ["SQLWrapper"] = "oxmysql", -- This can be `| oxmysql or ghmattimysql or mysql-async
    ["EmailEvent"] = "denalifw-phone:server:sendNewMail",
...
Config['CoreSettings'] = {
    ...
    ["DenaliFW"] = {
        ...
        ["Export"] = exports['denalifw-core']:GetCoreObject(), -- uncomment this if using new DenaliFW version
        ["Trigger"] = "DenaliFW:GetObject",
        ["HasItem"] = "DenaliFW:HasItem", -- Imporant [ Your trigger for checking has item, default is CORENAME:HasItem ] 
