...
BNEBoosting['functions'] = {
    GetCurrentBNE = function()
            ...
            DenaliFW.Functions.TriggerCallback('boosting:getCurrentBNE', function(amount)
                value =  amount.BNE
    ...
    RemoveBNE = function(amount)
            DenaliFW.Functions.TriggerCallback('boosting:removeBNE', function(amount) 
                end , amount)
                Wait(200)
            return true
    end,
    ...
    AddBne = function(amount)
            DenaliFW.Functions.TriggerCallback('boosting:addBne', function(amount)
                end , amount)
                Wait(200)
            return true
    end,
