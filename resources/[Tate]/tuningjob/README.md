# denalifw-mechanicjob
Mechanic Job for denalifw-Core Framework :mechanic:
...
- Import `denalifw-.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure denalifw-core
ensure denalifw-inventory
ensure denalifw-mechanicjob
```
